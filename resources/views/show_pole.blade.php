        ...
        <div class="card p-4 shadow-lg">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>{{ $pole->grade ?? 'N/A' }}</td>
                </tr>
                <tr>
                    <th>Batch Number</th>
                    <td>{{ $pole->batch_no ?? 'N/A' }}</td>
                </tr>
                <tr>
                    <th>Origin</th>
                    <td>{{ $pole->origin ?? 'N/A' }}</td>
                </tr>
                <tr>
                    <th>Asp</th>
                    <td>{{ $pole->asp ?? 'N/A' }}</td>
                ...
                <tr>
                    <th>Created At</th>
                    <td>{{ $pole->created_at }}</td>
                </tr>
                <tr>
                    <th>Updated At</th>
                    <td>{{ $pole->updated_at }}</td>
                </tr>
            </table>

            <div class="text-center mt-3">
                <a href="#" class="btn btn-success disabled" tabindex="-1" aria-disabled="true"
